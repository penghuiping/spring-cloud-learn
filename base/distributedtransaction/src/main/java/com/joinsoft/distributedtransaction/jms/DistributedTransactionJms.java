package com.joinsoft.distributedtransaction.jms;
...
import com.joinsoft.distributedtransaction.dto.TypeReferenceDto;
...
public class DistributedTransactionJms {
    ...
    public DistributedTransactionJms(RabbitTemplate rabbitTemplate,
                                     ObjectMapper objectMapper,
                                     DistributedTransactionMsgService distributedTransactionMsgService,
                                     TransactionTemplate transactionTemplate,
                                     ApplicationContext context,
                                     String queueName) {
        this.rabbitTemplate = rabbitTemplate;
        this.objectMapper = objectMapper;
        this.distributedTransactionMsgService = distributedTransactionMsgService;
    ...
    private void commonHandler() {
        ...
        try {
            ...
            channel.basicConsume(this.queueName, autoAck,
