...
public class AdminMenuRpcImpl implements AdminMenuRpc {
    ...
    @Override
    public ResultDto<List<AdminMenuButtonBo>> findAllMenuTree() {
        ...
        if (optionalAdminMenuButtonDtos.isPresent() && !optionalAdminMenuButtonDtos.get().isEmpty()) {
            ...
            return new ResultDto<>(true, adminMenuButtonDtos.stream().map(adminMenuButtonDto -> {
    ...
    @Override
    public ResultDto<List<AdminMenuButtonBo>> findAllByAdminRoleId(Long roleId) {
        //参数验证
        ...
        if (optionalAdminMenuButtonDtos.isPresent() && !optionalAdminMenuButtonDtos.get().isEmpty()) {
            return new ResultDto<>(true, optionalAdminMenuButtonDtos.get().stream().map(adminMenuButtonDto -> {
                AdminMenuButtonBo adminMenuButtonBo = new AdminMenuButtonBo();
                BeanUtils.copyProperties(adminMenuButtonDto, adminMenuButtonBo);
                return adminMenuButtonBo;
            }).collect(Collectors.toList()));
