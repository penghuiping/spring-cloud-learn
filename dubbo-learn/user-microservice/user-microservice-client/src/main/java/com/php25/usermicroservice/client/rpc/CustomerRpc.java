...
public interface CustomerRpc {
     ...
     */
    Boolean register(CustomerBo customerDto);
     ...
     * @return 前台用户信息
     */
    ResultDto<CustomerBo> findOne(String jwt);
     ...
     */
    Boolean update(CustomerBo customerDto);
     ...
     * @return 返回前台客户信息
     */
    ResultDto<CustomerBo> findCustomerDtoByMobile(String mobile);
