...
public interface AdminRoleRpc {
     ...
     * @return
     */
    ResultDto<DataGridPageDto<AdminRoleBo>> query(SearchParamBuilder searchParamBuilder, Integer pageNum, Integer pageSize, Sort sort);
     ...
     * @return 新增或者更新后的管理角色
     */
    ResultDto<AdminRoleBo> save(AdminRoleBo adminRoleDto);
